...
clean:
    ...
    rm -rf .build/iso .build/purebuild
...
bump-purebuild sha:
    ...
    sed -i -E "s/^ARG TACKLEBOX_SHA=.*/ARG TACKLEBOX_SHA=${new_sha}/" iso/Containerfile
    echo "Updated iso/Containerfile ARG TACKLEBOX_SHA=${new_sha}"
