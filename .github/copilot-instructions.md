# Copilot Instructions for neptuno
...
All coding agents should consult AGENTS.md for detailed instructions on working with the `neptuno` bootc image repository.
