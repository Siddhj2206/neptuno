...
| `bootc switch` fails                    | Wrong image URL or missing registry credentials             | Verify the payload ref matches your repo (see `iso/live.conf` IMGREF), check registry access                                           |
