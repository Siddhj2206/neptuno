...
- Probe third-party repos for the new major before pushing: COPRs (`.../results/<owner>/<project>/fedora-<N>-x86_64/`) and negativo17 publish Branched chroots early, but vendor repos like Tailscale may lag — check their `$releasever` path and pin the previous major meanwhile; see `finpilot-troubleshooting`
